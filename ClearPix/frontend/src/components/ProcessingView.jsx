...
const STEPS = [
  ...
  { id: 4, label: "Finishing result" },
];

// Advance through steps on a realistic cadence.
// Steps 1–2 are fast (UI feedback). Step 3 is the real AI work.
// Step 4 fires when the API responds.
const STEP_DELAYS = [0, 900, 1800, null]; // null = wait for API
